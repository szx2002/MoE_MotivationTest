...
def main():
    ...
    try:
        ...
        # 不使用is_moe_layer函数，直接在注册Hook时判断
        # 根据类名判断是否包含"moe"
        # 如果类名中包含"moe"则视为moe层，否则为普通层
